...
class CancelledBookingsController extends GetxController {
  ...
  String get _endpoint {
    return isProvider
        ? ApiUrl.providerCancelledBookings
        : ApiUrl.ownerCancelledBookings;
  }
  ...
  Future<void> fetchCancelledBookings() async {
    try {
      ...
      response.fold(
        (error) {
          Toast.errorToast(
            error.message ?? 'Failed to fetch cancelled bookings',
          );
        },
        (data) {
