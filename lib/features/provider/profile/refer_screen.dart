...
class _ReferScreenState extends State<ReferScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      appBar: CustomAppbar(titleName: ''
          'Refer Your \n Friends and Earn',leftIcon: true,),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      CustomText(text:
                        'Multiple referrals can extend the discount:',
                          fontSize: 12,
                        fontWeight: FontWeight.w700,
                      ),
                      SizedBox(height: 8),
                      Text('• 3 providers invited → 3 months discount'),
                      Text('• 5 providers invited → permanent -3% and "Scout Provider" badge'),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Spacer(),
                            CustomText(text: "Copy Code",color: AppColors.white_50,fontWeight: FontWeight.w400,fontSize: 12,)
                          ],
                        ),
                      )
                    ],
