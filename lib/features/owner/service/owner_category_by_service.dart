...
class OwnerCategoryByService extends StatefulWidget {
  const OwnerCategoryByService({super.key});

  @override
  State<OwnerCategoryByService> createState() => _OwnerCategoryByServiceState();
}

class _OwnerCategoryByServiceState extends State<OwnerCategoryByService> {
  @override
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio: 0.57, // Aspect ratio for grid items
        ),
