        ...
        children: [
          ...
          Positioned(
            ...
            child: CustomImage(
              ...
              height: MediaQuery.of(context).size.height * 0.48,  // Adjust height proportionally
            ),
          ),
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.only(
                    topLeft: Radius.circular(30),  // Set the top-left corner radius
                    topRight: Radius.circular(30), // Set the top-right corner radius
                  ),
                ),
                height: MediaQuery.of(context).size.height / 2.2,  // Adjust height based on screen size
