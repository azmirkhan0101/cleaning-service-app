...
class OwnerServiceDetailsScreen extends StatefulWidget {
  ...
  @override
  State<OwnerServiceDetailsScreen> createState() => _OwnerServiceDetailsScreenState();
}
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              CustomText(text: 'Jorge Bond', fontWeight: FontWeight.w600, fontSize: 14),

                              CustomText(text: 'jorgebong@gmail.com', fontSize: 14, color: AppColors.neutral03),
                        ...
                        Align(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              CustomText(text: 'Address', fontWeight: FontWeight.w600, fontSize: 14),

                              CustomText(text: 'Los Angeles, California', fontSize: 14, color: AppColors.neutral03),
                        ...
                        Align(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              CustomText(text: 'Experience', fontWeight: FontWeight.w600, fontSize: 14),

                              CustomText(text: '2 Years', fontSize: 14, color: AppColors.neutral03),
                        ...
                        Align(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              CustomText(text: 'About me', fontWeight: FontWeight.w600, fontSize: 14),
...
*/
                              ...
                              Text.rich(
                                TextSpan(
                                  text: 'Hello! I’m a dedicated cleaning service provider with a  passion for creating spotless,comfortable, and healthy spaces.',
                                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: AppColors.neutral03),
                                  children: [
                                    TextSpan(
                                      text: ' Read More',
                                      style: TextStyle(fontSize:14, fontWeight: FontWeight.w500, color: AppColors.lightBlue),
                                    ),
                                  ],
                                ),
                              )
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomText(text: "Booking Cancelled",
                    fontSize: 22,
                    fontWeight: FontWeight.w600,
                    color:AppColors.black,
                  ),
                  ...
                  CustomText(text: "Your booking has been Cancelled \n successfully.",
                    fontSize: 14,
                    fontWeight: FontWeight.w400,
