class ApiUrl {
 ...
 ///static const String baseUrl = "http://10.10.10.90:5000";
  ...
  static const String baseUrl = "https://hidaya-bakcend.onrender.com";
...
/// Update Prayer
 ...
 /// Delete Journals
  ...
  ///moodTrackerUpdate
  static String moodTrackerUpdate ({required String updateId}) =>"/api/user-moods/$updateId";

  ///moodTrackerDelete
  static String moodTrackerDelete ({required String deleteId}) =>"/api/user-moods/$deleteId";
